...
python detect_retina.py --backbone resnet18 --weights_path ../weights/20200531_1631_retinanet_resnet18_weights.pth.tar      --score_thres 0.4 --apply_nms False
...
python detect_retina.py --backbone resnet34 --weights_path ../weights/20200531_1659_retinanet_resnet34_weights.pth.tar      --score_thres 0.4 --apply_nms False
...
python detect_retina.py --backbone resnet50 --weights_path ../weights/20200531_1728_retinanet_resnet50_weights.pth.tar      --score_thres 0.4 --apply_nms False
...
python detect_retina.py --backbone resnext50 --weights_path ../weights/20200531_1852_retinanet_resnext50_weights.pth.tar --score_thres 0.4 --apply_nms False
...
python detect_retina.py --backbone resnext101 --weights_path ../weights/20200531_1932_retinanet_resnext101_weights.pth.tar --score_thres 0.4 --apply_nms False
